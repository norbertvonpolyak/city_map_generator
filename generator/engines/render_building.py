...
def render_map_building(
    *,
    ...
    if not render_only_buildings:
        ...
        _assert_polygon_fill_layer(water_p, "water_p", "building")
        ...
        if len(water_p) > 0:
            ...
            _assert_polygon_fill_layer(dissolved_water, "dissolved_water", "building")
        ...
        if coast_water is not None and len (coast_water) > 0:
            _assert_polygon_fill_layer(coast_water, "coast_water", "building")
            coast_water.plot (
                ax=ax,
                color=style_cfg.water,
                edgecolor="none",
